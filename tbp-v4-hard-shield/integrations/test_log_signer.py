...
class TestTBPLogSigner:
    ...
    def test_unicode_handling(self, signer):
        ...
        log = {"message": "Test with émojis 🎉 and ünïcödé", "amount": 1000}
    ...
    def test_nested_objects(self, signer):
        ...
        log = {
            "agent": {"id": "agent-001", "type": "trading"},
    ...
    def test_large_log(self, signer):
        ...
        large_log = {"data": "x" * 100000, "timestamp": datetime.now().isoformat()}  # 100KB of data
    ...
    def test_null_values(self, signer):
        ...
        log = {"value1": None, "value2": "test", "value3": None}
