...
class PatternMetrics:
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        return {
            ...
            "behavioral": {"similarity": self.pattern_similarity, "drift": self.behavioral_drift},
            "temporal": {
                "time_anomaly": self.time_of_day_anomaly,
                "weekend_anomaly": self.weekend_anomaly,
            },
            "sequential": {"similar_count": self.sequential_similar_count},
...
class PatternAnalyzer:
    ...
    def _update_baseline(self, agent_id: str, event: ActionEvent):
        ...
        for action_type, freq in freqs.items():
            ...
            baseline["action_frequencies"][action_type] = alpha * freq + (1 - alpha) * old_freq
...
if __name__ == "__main__":
    ...
    for i in range(5):
        action = {"agent_id": normal_agent, "action_type": "read", "amount": 0.0}
        metrics = analyzer.analyze(action)
