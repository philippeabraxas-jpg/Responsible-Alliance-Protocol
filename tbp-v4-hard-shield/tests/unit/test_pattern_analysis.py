...
class TestPatternMetrics:
    ...
    def test_metrics_to_dict(self):
        ...
        metrics = PatternMetrics(cumulative_amount_24h=50000.0, risk_score=75.0)
...
class TestPatternAnalyzerBasic:
    ...
    def test_multiple_actions(self, analyzer):
        ...
        for i in range(10):
            action = {"agent_id": agent_id, "action_type": "transfer", "amount": 1000.0}
    ...
    def test_different_agents_isolated(self, analyzer):
        ...
        # Agent 1
        analyzer.analyze({"agent_id": "bot-001", "action_type": "transfer", "amount": 5000.0})

        # Agent 2
        metrics2 = analyzer.analyze(
            {"agent_id": "bot-002", "action_type": "transfer", "amount": 3000.0}
        )
...
class TestSalamiAttackDetection:
    ...
    def test_small_repeated_transactions(self, analyzer):
        ...
        for i in range(100):
            action = {"agent_id": agent_id, "action_type": "transfer", "amount": 9999.0}
            metrics = analyzer.analyze(action)
    ...
    def test_cumulative_threshold_exceeded(self, analyzer):
        ...
        for i in range(15):
            action = {"agent_id": agent_id, "action_type": "transfer", "amount": 10000.0}
            metrics = analyzer.analyze(action)
    ...
    def test_sequential_similar_detection(self, analyzer):
        ...
        for i in range(10):
            action = {"agent_id": agent_id, "action_type": "transfer", "amount": 5000.0}
            metrics = analyzer.analyze(action)
    ...
    def test_burst_detection(self, analyzer):
        ...
        for i in range(50):
            action = {"agent_id": agent_id, "action_type": "transfer", "amount": 100.0}
            metrics = analyzer.analyze(action)
...
class TestBehavioralAnalysis:
    ...
    def test_pattern_similarity(self, analyzer):
        ...
        for i in range(10):
            analyzer.analyze({"agent_id": agent_id, "action_type": "read", "amount": 100.0})

        # Continue same pattern
        metrics = analyzer.analyze({"agent_id": agent_id, "action_type": "read", "amount": 100.0})
    ...
    def test_behavioral_drift(self, analyzer):
        ...
        for i in range(20):
            analyzer.analyze({"agent_id": agent_id, "action_type": "read", "amount": 0.0})

        # Suddenly switch to transfers
        for i in range(20):
            analyzer.analyze({"agent_id": agent_id, "action_type": "transfer", "amount": 1000.0})

        # Get final metrics
        metrics = analyzer.analyze(
            {"agent_id": agent_id, "action_type": "transfer", "amount": 1000.0}
        )
...
class TestTemporalAnalysis:
    ...
    def test_time_of_day_anomaly(self, analyzer):
        ...
        action = {"agent_id": "bot-night", "action_type": "transfer", "amount": 5000.0}
...
class TestRiskScoring:
    ...
    def test_risk_score_bounds(self, analyzer):
        ...
        # Extreme scenario
        for i in range(1000):
            action = {"agent_id": "bot-extreme", "action_type": "transfer", "amount": 50000.0}
            metrics = analyzer.analyze(action)
    ...
    def test_low_risk_normal_behavior(self, analyzer):
        ...
        for i in range(3):
            action = {"agent_id": "bot-normal", "action_type": "read", "amount": 10.0}
            metrics = analyzer.analyze(action)
...
class TestPersistence:
    ...
    def test_save_and_load(self):
        ...
        try:
            ...
            for i in range(5):
                analyzer.analyze(
                    {"agent_id": "bot-persist", "action_type": "transfer", "amount": 1000.0}
                )
...
class TestAgentSummary:
    ...
    def test_get_summary(self, analyzer):
        ...
        # Add some actions
        for i in range(5):
            analyzer.analyze({"agent_id": agent_id, "action_type": "transfer", "amount": 2000.0})
    ...
    def test_reset_agent(self, analyzer):
        ...
        # Add data
        analyzer.analyze({"agent_id": agent_id, "action_type": "transfer", "amount": 5000.0})
