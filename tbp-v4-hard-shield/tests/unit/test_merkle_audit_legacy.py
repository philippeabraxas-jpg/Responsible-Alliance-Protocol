...
class TestAuditEntry:
    ...
    def test_serialization(self):
        ...
        original = AuditEntry(
            {"agent": "bot-001", "action": "trade"}, previous_hash="abc123", signature=b"fake_sig"
        )
...
class TestIntegrationWithHSM:
    ...
    def test_append_with_signature(self):
        ...
        chain.append({"agent": "bot-001", "action": "trade"}, signature=fake_signature)
    ...
    def test_signature_preserved_after_save(self):
        ...
        try:
            ...
            chain1.append({"test": "data"}, signature=b"test_signature")
