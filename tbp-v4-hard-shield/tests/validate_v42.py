...
class ValidationRunner:
    ...
    def check_hsm_performance(self):
        ...
        try:
            ...
            passed = p95_lat <= 5.0
            self.print_check(
                "HSM Latency (P95 < 5ms)", passed, f"Avg: {avg_lat:.2f}ms, P95: {p95_lat:.2f}ms"
            )
    ...
    def check_rate_limiting(self):
        ...
        try:
            ...
            self.print_check(
                ...
                passed,
                (
                    "Blocked attacker after 5 requests"
                    if passed
                    else f"Failed: success={success_count}, blocked={blocked}"
                ),
            )
        except Exception as e:
        ...
        try:
            ...
            for _ in range(10):
                metrics = analyzer.analyze(
                    {"agent_id": "bot-001", "action": "transfer", "amount": 150}
                )
    ...
    def check_full_audit_chain(self):
        ...
        try:
            config = {
                ...
                "storage_path": "tests/test_audit_chain.json",
            }
